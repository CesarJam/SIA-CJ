<template>
    <div
        :class="['fixed inset-0 z-[60] flex items-center justify-center p-4 sm:p-6', modelValue ? 'pointer-events-auto' : 'pointer-events-none']">
        ...
        <transition enter-active-class="ease-out duration-300" enter-from-class="opacity-0 scale-95"
            ...
            <div v-if="modelValue"
                ...
                <div
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <span class="px-2.5 py-1 text-xs font-bold rounded-full"
                            :class="badgeColor(expediente?.estatus)">
                            {{ expediente?.estatus }}
                        </span>
                    </div>
                ...
                <div v-if="expediente?.estatus === 'Cancelado'"
                ...
                <div class="p-6 overflow-y-auto flex-1 space-y-6">
                    ...
                    <div
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-y-4 gap-x-6">
                            ...
                            <div>
                                <span class="block text-[11px] font-bold text-gray-500 uppercase">Carácter /
                                    Prioridad</span>
                                <div class="mt-1">
                            ...
                            <div class="md:col-span-3">
                                ...
                                <p
                                    class="text-sm text-gray-800 dark:text-gray-200 italic bg-gray-50 dark:bg-gray-900/50 p-2 rounded border border-gray-100 dark:border-gray-700/50">
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <span
                                    ...
                                    obtenerValorArreglo(expediente?.tradicion) }}</span>
                            </div>
                            <div>
                                <span class="block text-[10px] font-bold text-gray-500 uppercase">Soporte</span>
                                <span
                                    class="text-xs font-semibold text-gray-800 dark:text-gray-200 bg-gray-100 dark:bg-gray-700 px-2 py-0.5 rounded">{{
                                    obtenerValorArreglo(expediente?.soporte) }}</span>
                            </div>
                            <div>
                                <span class="block text-[10px] font-bold text-gray-500 uppercase">Acceso</span>
                                <span
                                    class="text-xs font-semibold text-gray-800 dark:text-gray-200 bg-gray-100 dark:bg-gray-700 px-2 py-0.5 rounded">{{
                                        obtenerValorArreglo(expediente?.condicion_acceso) }}</span>
                            </div>
                            <div>
                                <span class="block text-[10px] font-bold text-gray-500 uppercase">Inmueble /
                                    Gaveta</span>
                                <span class="text-xs text-gray-800 dark:text-gray-200">{{ expediente?.inmueble || "No
                                    definido" }}</span>
                            </div>
                        </div>

                        <div v-if="expediente?.snapshot_cadido"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                                <div class="md:col-span-2">
                                    ...
                                    <span class="text-sm font-bold text-gray-800 dark:text-gray-200">
                                        ...
                                        expediente.snapshot_cadido.nombre_subserie }}
                                    </span>
                                </div>
                                <div>
                                ...
                                <div>
                                    <span class="block text-[10px] font-bold text-emerald-600 uppercase">Años
                                        Trámite</span>
                                    <span class="text-sm font-bold text-gray-800 dark:text-gray-200">{{
                                        expediente.snapshot_cadido.anios_tramite }}</span>
                                </div>
                                <div class="md:col-span-2">
                                    <span class="block text-[10px] font-bold text-emerald-600 uppercase">Años
                                        Concentración</span>
                        ...
                        <div class="mt-5 pt-4 border-t border-gray-100 dark:border-gray-700">
                            ...
                            <GestorDocumental v-if="expediente" :expedienteId="expediente.id"
                                :folio="expediente.numero_consecutivo" modo="lectura" />
                        </div>
                    </div>
                        ...
                        <div v-else
                            ...
                            <div v-for="(mov, idx) in historialBitacora" :key="idx" class="relative pl-6">
                                ...
                                <div class="flex flex-col sm:flex-row sm:justify-between sm:items-baseline gap-1 mb-1">
                                    <div class="flex items-center gap-2 flex-wrap">
                                        ...
                                        <span v-if="mov.usuario"
                                            ...
                                            {{ mov.usuario.nombre || 'Desconocido' }} / {{ mov.usuario.email ||
                                            'Desconocido' }}
                                        </span>
                                    </div>
                                ...
                                <div class="text-xs text-gray-600 dark:text-gray-400 mt-2">
                                    ...
                                    <span
                                        :class="badgeColor(mov.detalles?.estatus_nuevo || mov.detalles?.estatus_inicial || 'Recepcionado')"
                                        class="px-1.5 py-0.5 rounded ml-1 border">
                                        {{ mov.detalles?.estatus_nuevo || mov.detalles?.estatus_inicial ||
                                        "Recepcionado" }}
                                    </span>
                                </div>
                            </div>
